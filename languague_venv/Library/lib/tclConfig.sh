...
# installed.
TCL_PREFIX='G:/voice translator/eng_to_poshto/langauge_translation/languague_venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='G:/voice translator/eng_to_poshto/langauge_translation/languague_venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='G:/voice translator/eng_to_poshto/langauge_translation/languague_venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IG:/voice translator/eng_to_poshto/langauge_translation/languague_venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LG:/voice translator/eng_to_poshto/langauge_translation/languague_venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='G:/voice translator/eng_to_poshto/langauge_translation/languague_venv\Library\lib\tclstub86.lib'
